...
class MyForegroundService : Service() {
    ...
    private fun startLocationUpdates(apiBase: String?, authToken: String?, busId: Int) {
        val request = LocationRequest.Builder(Priority.PRIORITY_HIGH_ACCURACY, 3_000L)
            .setMinUpdateIntervalMillis(3_000L)  // Minimum interval between updates
            .setMaxUpdateDelayMillis(3_000L)     // Force batched updates delivery
            .setMinUpdateDistanceMeters(0f)      // 0 = send even if not moving
